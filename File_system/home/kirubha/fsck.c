...
char **argv;
{
	...
	int result =0;
	char path[128];
	printf("\nFrom Repair Inode and Zone map\n");
	printf("Enter the file path to check Mount File to check:");
	scanf("%s", path);
	repair ^= 1;
	chkdev(path, clist, ilist, zlist);
	clist = 0;
	ilist = 0;
	zlist = 0;
	devgiven = 1;
