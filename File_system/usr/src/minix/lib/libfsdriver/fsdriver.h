...
/*==============================================new declarations=================================================== */
extern int fsdriver_iwalker(const struct fsdriver * __restrict,
	const message * __restrict, message * __restrict);
extern int fsdriver_zwalker(const struct fsdriver * __restrict,
	const message * __restrict, message * __restrict);
extern int fsdriver_dinode(const struct fsdriver * __restrict,
	const message * __restrict, message * __restrict);
extern int fsdriver_rinode(const struct fsdriver * __restrict,
	const message * __restrict, message * __restrict);
