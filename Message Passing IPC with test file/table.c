...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_mq_close,		/* 56 = Clear the queue*/
	no_sys,		/* 57 = unused	*/
	do_queue_search,		/* 58 = QUEUE LIST	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	do_set,		/* 62 = setsid	*/
	...
	do_mq_send,		/* 69 = mq_send	*/	//--------------------------------------------------added
	do_mq_receiver,	/* 70 = message recive */		//--------------------------------------------------added
	...
	do_mq_open,		/* 79 = queue Create */ //--------------------------------------------------added
	no_sys,		/* 80 = (getdents) */
	no_sys, 	/* 81 = unused */
	no_sys, 	/* 82 = (fstatfs) */
	no_sys, 	/* 83 = unused */
